...
| **D-14** | **Falta variante compacta.** PRD Nº8 §24 pide `dark`/`light`/`compact`, y §26 define un header que se compacta al hacer scroll. La lámina muestra marca compacta en móvil. No se entregó.                                                             | F8          | ❓ Bloquea el header condensado.                                                                                                          |
