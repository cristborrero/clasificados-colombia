...
export function Display({ children, className, as: Component = 'h1' }: BaseProps) {
  return (
    <Component className={cn(editorial, 'text-display font-black text-balance', className)}>
      {children}
    </Component>
  )
}
...
export function HeadlineXL({ children, className, as: Component = 'h1' }: BaseProps) {
  return (
    <Component className={cn(editorial, 'text-h1 font-bold text-balance', className)}>
      {children}
    </Component>
  )
}

export function HeadlineLG({ children, className, as: Component = 'h2' }: BaseProps) {
  return (
    <Component className={cn(editorial, 'text-h2 font-bold text-balance', className)}>
      {children}
    </Component>
  )
}

export function HeadlineMD({ children, className, as: Component = 'h3' }: BaseProps) {
  return (
    <Component className={cn(editorial, 'text-h3 font-semibold text-balance', className)}>
      {children}
    </Component>
  )
}
 ...
 * long as a paragraph.
 */
export function Dek({ children, className, as: Component = 'p' }: BaseProps) {
  return (
    <Component
...
export function Lead({ children, className, as: Component = 'p' }: BaseProps) {
  return <Component className={cn(sans, 'text-lead text-pretty', className)}>{children}</Component>
}

/** Reading text. The most important size in the product (PRD Nº8 §12). */
export function Body({ children, className, as: Component = 'p' }: BaseProps) {
  return <Component className={cn(sans, 'text-body text-pretty', className)}>{children}</Component>
}

export function BodyLarge({ children, className, as: Component = 'p' }: BaseProps) {
  return (
    <Component className={cn(sans, 'text-body-lg text-pretty', className)}>{children}</Component>
  )
}

/** Dates, reading time, bylines, source notes. */
export function Metadata({ children, className, as: Component = 'p' }: BaseProps) {
  return (
    <Component className={cn(sans, 'text-metadata text-[var(--color-text-subtle)]', className)}>
      {children}
    </Component>
  )
}
 ...
 */
export function Eyebrow({ children, className, as: Component = 'p' }: BaseProps) {
  return (
    <Component
      className={cn(
        sans,
...
export function Caption({ children, className, as: Component = 'figcaption' }: BaseProps) {
  return (
    <Component className={cn(sans, 'text-metadata text-[var(--color-text-subtle)]', className)}>
      {children}
    </Component>
 ...
 */
export function Quote({ children, className, as: Component = 'blockquote' }: BaseProps) {
  return (
    <Component
      className={cn(
        editorial,
...
export function DataFigure({ children, className, as: Component = 'p' }: BaseProps) {
  return (
    <Component
      className={cn(
        editorial,
