  ...
  return (
    <form action="/buscar" method="get" role="search" className="flex gap-2">
      ...
      <input
        ...
        className={cn(
          'flex-1 border border-[var(--color-border)] bg-[var(--color-surface-raised)]',
      ...
      <button
        type="submit"
        className={cn(
          'inline-flex items-center gap-2 border border-[var(--color-ink)] bg-[var(--color-ink)] px-5 py-3',
