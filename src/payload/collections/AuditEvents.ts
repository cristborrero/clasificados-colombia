  ...
  fields: [
...

    {
      ...
      options: [
        ...
        { label: 'Evidencia cargada', value: 'evidence_uploaded' },
        { label: 'Evidencia descargada', value: 'evidence_downloaded' },
        { label: 'Acceso a evidencia denegado', value: 'evidence_access_denied' },
        { label: 'Clasificación modificada', value: 'classification_changed' },
        { label: 'Acceso concedido', value: 'access_granted' },
        { label: 'Acceso revocado', value: 'access_revoked' },
        { label: 'Retención legal modificada', value: 'legal_hold_changed' },
